...
RSpec.describe ChefDK::Template::PluginBase do
  before do
  ...
  it 'can be constructed' do
    template = ChefDK::Template::Plugin::Amazing.new(@recipe)
    expect(template).to be_a ChefDK::Template::PluginBase
  end
  ...
  it 'calls mixin methods' do
    ...
    template = ChefDK::Template::Plugin::Amazing.new(@recipe)
    template.extend ChefDK::Template::Mixin::Bar
    template.generate
  end
