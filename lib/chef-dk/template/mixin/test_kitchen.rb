  ...
  module Template
    module Mixin
      ...
      module TestKitchen
        ...
        #   will be injected
        # @return [void]
        def mixin_testkitchen_config(recipe)
        ...
        #   will be injected
        # @return [void]
        def mixin_testkitchen_dirs(recipe)
          @directories << 'test'
        ...
        #   will be injected
        # @return [void]
        def mixin_testkitchen_spechelper(recipe)
        ...
        #   will be injected
        # @return [void]
        def mixin_testkitchen_defaultrecipespec(recipe)
          @templates_if_missing << File.join(
            'test', 'integration', 'default', 'serverspec',
